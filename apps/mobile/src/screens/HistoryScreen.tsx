...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: 'bold', color: '#FFD700', marginBottom: 16, textAlign: 'center' },
  ...
  recordDate: { color: '#FFD700', fontWeight: 'bold', fontSize: 14 },
  ...
  aiLabel: { color: '#FFD700', fontSize: 13, fontWeight: 'bold', marginBottom: 4 },
